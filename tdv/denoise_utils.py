...
def apply_vn(x_0, z, vn, sigma, sigma_ref=25):
...
def denoise_z(vn, z, sigma=25, sigma_ref=25):
...
def test_img(vn, img, sigma, add_noise=True, noisy_img_path=None, n_bits = 8):
    ...
    x_S = denoise_z(vn, z, sigma, sigma_ref)
